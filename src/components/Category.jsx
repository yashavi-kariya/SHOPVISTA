...
.insta-overlay svg { width: 28px; height: 28px; fill: none; stroke: #fff; stroke-width: 1.5; }
.insta-text-wrap {
    flex: 0 0 300px;
    opacity: 0;
...
/* Desktop — 3 columns, hide 4th card */
.blog-grid {
    display: grid;
    grid-template-columns: repeat(3, 1fr);
    gap: 24px;
}
.blog-card:nth-child(4) { display: none; }
...
/* 900px — tablet: single merged block */
@media (max-width: 900px) {
    ...
    .blog-card:nth-child(4) { display: block; }
}

/* 640px — mobile: single merged block */
@media (max-width: 640px) {
    /* Deal — full bleed hero */
    .deal-section { padding: 24px 16px; }
    .deal-container {
        display: block;
        padding: 0;
        position: relative;
    ...
    .deal-sticker { right: 12px !important; top: 12px !important; z-index: 3; }
    .deal-text-side {
        position: relative;
        z-index: 2;
    ...
    .deal-btn { display: block; text-align: center; background: #fff; color: #111; margin-top: 4px; }
    ...
    .blog-card:nth-child(4) { display: block; }
    .blog-card__pic { height: 150px; }
    .blog-card__body { padding: 14px 14px 18px; }
    .blog-card__title { font-size: 13px; }
}

/* 400px — very small: single merged block */
