...
//         console.log("SUBMIT images:", form.images, "img:", form.img);
                            ...
                            <div style={{ marginTop: "16px" }}>
                                ...
                                <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
                                    {selectedProduct.variants.map((v, i) => {
                                        ...
                                        return (
                                            <div key={i} style={{ display: "flex", justifyContent: "space-between", padding: "8px 12px", background: "#f9f9f9", borderRadius: "8px", fontSize: "13px", alignItems: "center" }}>
