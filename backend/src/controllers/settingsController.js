...
export const updateSettings = async (req, res) => {
    try {
        const { shippingCharge, freeShippingThreshold, couponTiers, defaultReturnWindowDays } = req.body;
        ...
        if (defaultReturnWindowDays !== undefined) settings.defaultReturnWindowDays = Number(defaultReturnWindowDays);
